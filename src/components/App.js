    ...
    <>
      <div className="header">
        ...
        <div className="dropping-texts">
          <div className="color1">HTML</div>
          <div className="color1">CSS</div>
          <div className="color1">JS</div>
          <div className="color2">CoderHCJ</div>
        </div>
      </div>
      <a
        href="https://github.com/Akash-Ramjyothi/Coder-HCJ"
        class="github-corner"
